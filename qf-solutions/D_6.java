...
public class TASK_D {
    ...
    public static long modMult(long a, long b, long modulo) {
        BigInteger chiselko1 = new BigInteger(String.valueOf(a));
        BigInteger chiselko2 = new BigInteger(String.valueOf(b));
        BigInteger mult = chiselko1.multiply(chiselko2);
        mult = mult.mod(new BigInteger(String.valueOf(modulo)));
        return Long.parseLong(mult.toString());
    }
